...
static inline void rb_erase(struct rb_node *,
			    struct rb_root *);
...
static inline struct rb_node *rb_first_postorder(
...
static inline void rb_erase_init(struct rb_node *n,
				 struct rb_root *root)
{
	rb_erase(n, root);
	RB_CLEAR_NODE(n);
...
static inline void rb_insert_color(struct rb_node *node,
				   struct rb_root *root)
{
	__rb_insert(node, root);
}

static inline void rb_erase(struct rb_node *node,
			    struct rb_root *root)
{
	struct rb_node *rebalance;
